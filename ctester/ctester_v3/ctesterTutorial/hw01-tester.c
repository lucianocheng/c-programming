...
void test_get_user_input_ADD_return();
void test_get_user_input_SUB();
void test_get_user_input_SUB_return();
void test_get_user_input_MUL();
void test_get_user_input_MUL_return();
void test_get_user_input_DIV();
void test_get_user_input_DIV_return();
...
int main(int argc, char * argv[]) {
	...
	add_new_test(prob1, "test_get_user_input_ADD", 7,
		&test_get_user_input_ADD);
	add_new_test(prob1, "test_get_user_input_ADD_return", 3,
		&test_get_user_input_ADD_return);
	add_new_test(prob1, "test_get_user_input_SUB", 7,
		&test_get_user_input_SUB);
	add_new_test(prob1, "test_get_user_input_SUB_return", 3,
		&test_get_user_input_SUB_return);
	add_new_test(prob1, "test_get_user_input_MUL", 7,
		&test_get_user_input_MUL);
	add_new_test(prob1, "test_get_user_input_MUL_return", 3,
		&test_get_user_input_MUL_return);
	add_new_test(prob1, "test_get_user_input_DIV", 7,
		&test_get_user_input_DIV);
	add_new_test(prob1, "test_get_user_input_DIV_return", 3,
		&test_get_user_input_DIV_return);
