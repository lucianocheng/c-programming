...
void test_calculate_resistance_TONY_STARK();
void test_calculate_resistance_BATMAN();
...
int main(int argc, char * argv[]) {
  ...
  PROBLEM * prob5 = add_new_problem("query_user", 5);
	...
	add_new_fork_test(prob1, "test_count_down_1", 5,
		&test_count_down_1);
	add_new_fork_test(prob1, "test_count_down_10", 5,
		&test_count_down_10);
	add_new_fork_test(prob1, "test_count_down_50", 5,
		&test_count_down_50);
	add_new_fork_test(prob1, "test_count_down_100", 5,
		&test_count_down_100);

  add_new_fork_test(prob2, "test_get_max_age_5", 5,
    &test_get_max_age_5);
  add_new_fork_test(prob2, "test_get_max_age_10", 5,
    &test_get_max_age_10);
  add_new_fork_test(prob2, "test_get_max_age_50", 5,
    &test_get_max_age_50);
  add_new_fork_test(prob2, "test_get_max_age_100", 5,
    &test_get_max_age_100);

  add_new_fork_test(prob3, "test_get_human_average_age_5pt5", 5, 
    &test_get_human_average_age_5pt5);
  add_new_fork_test(prob3, "test_get_human_average_age_40pt2", 5, 
    &test_get_human_average_age_40pt2);
  add_new_fork_test(prob3, "test_get_human_average_age_60", 5, 
    &test_get_human_average_age_60);
  add_new_fork_test(prob3, "test_get_human_average_age_30", 5, 
    &test_get_human_average_age_30);

  add_new_fork_test(prob4, "test_calculate_resistance_CARE_BEARS", 5, 
    &test_calculate_resistance_CARE_BEARS);
  add_new_fork_test(prob4, "test_calculate_resistance_TONY_STARK", 5, 
    &test_calculate_resistance_TONY_STARK);
  add_new_fork_test(prob4, "test_calculate_resistance_BATMAN", 5, 
    &test_calculate_resistance_BATMAN);
  add_new_fork_test(prob4, "test_calculate_resistance_CHUCK_NORRIS", 5, 
    &test_calculate_resistance_CHUCK_NORRIS);

  add_new_fork_test(prob5, "test_query_user_COUNTDOWN", 2, 
    &test_query_user_COUNTDOWN);
  add_new_fork_test(prob5, "test_query_user_MAX_AGE", 2, 
    &test_query_user_MAX_AGE);
  add_new_fork_test(prob5, "test_query_user_AVG_AGE", 2, 
    &test_query_user_AVG_AGE);
  add_new_fork_test(prob5, "test_query_user_RESISTANCE", 2, 
    &test_query_user_RESISTANCE);
  add_new_fork_test(prob5, "test_query_user_HELP", 2, 
    &test_query_user_HELP);
  add_new_fork_test(prob5, "test_query_user_EXIT", 2, 
    &test_query_user_EXIT);
  add_new_fork_test(prob5, "test_query_user_ERROR", 4, 
    &test_query_user_ERROR);
  add_new_fork_test(prob5, "test_query_user_SWITCH_STATEMENT", 4, 
...
void test_calculate_resistance_CARE_BEARS(){
  assert_equals_int("calculate_resistance(): max=9, avg=4.0, expect CARE_BEARS (0)", 
  		CARE_BEARS, calculate_resistance(9, 4.0));
}

void test_calculate_resistance_TONY_STARK(){
  assert_equals_int("calculate_resistance(): max=8, avg=9.0, expect TONY_STARK (1)", 
  		TONY_STARK, calculate_resistance(8, 9.0));
}

void test_calculate_resistance_BATMAN(){
  assert_equals_int("calculate_resistance(): max=1, avg=26, expect BATMAN (2)", 
  		BATMAN, calculate_resistance(1, 26.0));
}
