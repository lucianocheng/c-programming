...
void conductGetWordTest(char* name, char* testString, int givenArraySize, int expectedResponse, char* expectedString){
  ...
  if(expectedResponse != EOF_BEFORE_WORD){
    luke_assert_equals_string(name, expectedString, sendString);
  }
}
...
void getWord_wordTooLong(){
  conductGetWordTest("Word Too Long, expected 9 characters + NULL in 10 character array", "hellomynameis", 10, READ_WORD_SUCCESS, "hellomyna");
}
...
void sortWords_OneWord(){
  ...
  for(i = 0; i < wordCount; i++){
    luke_assert_equals_string("Sort Test 1 Word", expectedArray[i], sentArray[i]);
  }
}
void sortWords_FiveWord(){
  int wordCount = 5;
  ...
  int i = 0;
  for(i = 0; i < wordCount; i++){
    luke_assert_equals_string("Sort Test 5 Words", expectedArray[i], sentArray[i]);
  }
}
...
void sortWords_TenWord(){
  ...
  int i = 0;
  for(i = 0; i < wordCount; i++){
    luke_assert_equals_string("Sort Test 10 Words", expectedArray[i], sentArray[i]);
  }
}
...
void sortWords_TwentyFiveWord(){
  ...
  int i = 0;
  for(i = 0; i < wordCount; i++){
    luke_assert_equals_string("Sort Test 25 Word", expectedArray[i], sentArray[i]);
  }
}
...
void sortWords_EdgeCaseWord(){
  ...
  int i = 0;
  for(i = 0; i < wordCount; i++){
    luke_assert_equals_string("Sort Test Edge Cases", expectedArray[i], sentArray[i]);
  }
}
