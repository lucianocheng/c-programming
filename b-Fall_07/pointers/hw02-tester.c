...
// Unpack Data = 20 PTS
void testUnPackData_160CharForwards();
void testUnPackData_160CharRandom();
void testUnPackData_100CharForwards();
void testUnPackData_100CharRandom();
void testUnPackData_12CharForwards();
void testUnPackData_12CharRandom();
void testUnPackData_25CharForwards();
void testUnPackData_25CharRandom();
void testUnPackData_oneCharForwards();
void testUnPackData_oneCharRandom();

// Get empty packet
char** getEmptyPackets(int);
int makePackets(char[], int, char*[], int);
void testUnpackData(int, int);
...
int main(int argc, char * argv[]) {
	...
	// Pointer to Vowel = 20 PTS
	add_new_test(prob1, "testPointerToVowel_x", 4, 
		&testPointerToVowel_x);
	add_new_test(prob1, "testPointerToVowel_y", 4, 
		&testPointerToVowel_y);
	add_new_test(prob1, "testPointerToVowel_z", 4, 
		&testPointerToVowel_z);
	add_new_test(prob1, "testPointerToVowel_w", 4, 
		&testPointerToVowel_w);
	add_new_test(prob1, "testPointerToVowel_err", 4,
		&testPointerToVowel_err);

	// Last Word = 20 PTS
	add_new_test(prob2, "testPointerToLastWord_oneWord", 4,
		&testPointerToLastWord_oneWord);
	add_new_test(prob2, "testPointerToLastWord_twoWord", 4,
		&testPointerToLastWord_twoWord);
	add_new_test(prob2, "testPointerToLastWord_threeWord", 4,
		&testPointerToLastWord_threeWord);
	add_new_test(prob2, "testPointerToLastWord_spaceAndEmpty", 4,
		&testPointerToLastWord_spaceAndEmpty);
	add_new_test(prob2, "testPointerToLastWord_null", 4,
		&testPointerToLastWord_null);

	add_new_test(prob3, "testReverse_smallString", 4,
		&testReverse_smallString);
	add_new_test(prob3, "testReverse_longString", 4,
		&testReverse_longString);
	add_new_test(prob3, "testReverse_oddLetters", 4,
		&testReverse_oddLetters);
	add_new_test(prob3, "testReverse_evenLetters", 4,
		&testReverse_evenLetters);
	add_new_test(prob3, "testReverse_nullAndEmpty", 2,
		&testReverse_nullAndEmpty);

	add_manual_grade(prob3, "used pointer notation", 2, FALSE);

        
	// Pack Data = 20 PTS
	add_new_test(prob4, "testPackData_messageNumber", 2,
		&testPackData_messageNumber);
	add_new_test(prob4, "testPackData_indexNumber", 2,
		&testPackData_indexNumber);
	add_new_test(prob4, "testPackData_nextFlag", 2,
		&testPackData_moreFlag);
	add_new_test(prob4, "testPackData_dataSize", 2,
		&testPackData_dataSize);
	add_new_test(prob4, "testPackData_oneChar", 3,
		&testPackData_oneChar);
	add_new_test(prob4, "testPackData_12Char", 3,
		&testPackData_12Char);
	add_new_test(prob4, "testPackData_25Char", 3,
		&testPackData_25Char);
	add_new_test(prob4, "testPackData_error", 3,
		&testPackData_error);
	
	// Unpack Data = 20 PTS
	add_new_test(prob5, "testUnPackData_160CharForwards", 2, 
		testUnPackData_160CharForwards);
	add_new_test(prob5, "testUnPackData_160CharRandom", 2,
		testUnPackData_160CharRandom);
	add_new_test(prob5, "testUnPackData_100CharForwards", 2, 
		testUnPackData_100CharForwards);
	add_new_test(prob5, "testUnPackData_100CharRandom", 2,
		testUnPackData_100CharForwards);
	add_new_test(prob5, "testUnPackData_12CharForwards", 2, 
		testUnPackData_12CharForwards);
	add_new_test(prob5, "testUnPackData_12CharRandom", 2, 
		testUnPackData_12CharRandom);
	add_new_test(prob5, "testUnPackData_25CharForwards", 2, 
		testUnPackData_25CharForwards);
	add_new_test(prob5, "testUnPackData_25CharRandom", 2, 
		testUnPackData_25CharRandom);
	add_new_test(prob5, "testUnPackData_oneCharForwards", 2, 
		testUnPackData_oneCharForwards);
	add_new_test(prob5, "testUnPackData_oneCharRandom", 2, 
		testUnPackData_oneCharRandom);
...
void testUnpackData(int size, int randomized){
  char dataSent[256];
  ...
  sprintf(message, "result_size = %d", size);
  ...
  assert_equals_int("Arrays not equal at (should be -1)", -1, notEqualAt);
}
...
// Unpack Data = 20 PTS
void testUnPackData_160CharForwards(){
  testUnpackData(160, FALSE);
}

void testUnPackData_160CharRandom(){
  testUnpackData(160, TRUE);
}

void testUnPackData_100CharForwards(){
  testUnpackData(100, FALSE);
}

void testUnPackData_100CharRandom(){
  testUnpackData(100, TRUE);
}

void testUnPackData_12CharForwards(){
  testUnpackData(12, FALSE);
}

void testUnPackData_12CharRandom(){
  testUnpackData(12, TRUE);
}

void testUnPackData_25CharForwards(){
  testUnpackData(25, FALSE);
}

void testUnPackData_25CharRandom(){
  testUnpackData(25, TRUE);
}

void testUnPackData_oneCharForwards(){
  testUnpackData(1, FALSE);
}

void testUnPackData_oneCharRandom(){
  testUnpackData(1, TRUE);
}
