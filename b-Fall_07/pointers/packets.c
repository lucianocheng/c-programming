 ...
 *
 * When you have read in all packets and formatted the data, return the total length of the 
 * data you read in
 */
...
/**
 * returns the current message index number.  Used by the tester, and needed to format your
 * packet according to the description above.
 */
int getMsgNumber(){
